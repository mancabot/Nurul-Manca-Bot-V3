...
* New Features
*/
// GaMau Donasi? Follow Aja
// Follow IG Ku @thenay_xploit_
const {
    WAConnection,
    MessageType,
    Presence,
...
prefix = "#"
name = "~ 𝙼𝙰𝙽𝙲𝙰-𝙱𝙾𝚃"
rdaftar = "𝚃𝙴𝚁𝙸𝙼𝙰 𝙺𝙰𝚂𝙸𝙷 𝚃𝙴𝙻𝙰𝙷 𝙳𝙰𝙵𝚃𝙰𝚁 𝙼𝙴𝙽𝙹𝙰𝙳𝙸 𝚃𝙴𝙼𝙰𝙽 𝙼𝙰𝙽𝙲𝙰-𝙱𝙾𝚃🤗"
rmenu = "𝙷𝙰𝙸 𝚃𝙴𝙼𝙰𝙽 𝙼𝙰𝙽𝙲𝙰-𝙱𝙾𝚃👋"
botinfo = "𝚄𝙽𝚃𝚄𝙺 𝙸𝙽𝚅𝙸𝚃𝙴 𝙱𝙾𝚃 𝙵𝙾𝙻𝙻𝙾𝚆 𝙸𝙶 𝙺𝚄 𝙳𝚄𝙻𝚄ツ"
limitt = 10000
memberLimit = 1
ban = []
...
async function starts() {
	...
	frhan.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Sayonara @${num.split('@')[0]} Manca-Bot Sayang Kamuツ`
				let buff = await getBuffer(ppimg)
				frhan.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	frhan.on('chat-update', async (mek) => {
		try {
			...
			const NurulCans = ["0@s.whatsapp.net"] // ubah aja gapapa
			...
			mess = {
				wait: '*⏳𝑊𝑎𝑖𝑡... 𝑆𝑒𝑑𝑎𝑛𝑔 𝐷𝑖 𝑃𝑟𝑜𝑠𝑒𝑠 𝑂𝑙𝑒ℎ 𝑀𝑎𝑛𝑐𝑎-𝐵𝑜𝑡*',
				success: '*𝑆𝑢𝑘𝑠𝑒𝑠 𝐻𝑜𝑟𝑒...*',
				error: {
					stick: ' *𝐺𝑎𝑔𝑎𝑙, 𝑇𝑒𝑟𝑗𝑎𝑑𝑖 𝐾𝑒𝑠𝑎𝑙𝑎ℎ𝑎𝑛 𝑆𝑎𝑎𝑡 𝑀𝑒𝑛𝑔𝑘𝑜𝑛𝑣𝑒𝑟𝑠𝑖 𝐺𝑎𝑚𝑏𝑎𝑟 𝐾𝑒 𝑆𝑡𝑖𝑐𝑘𝑒𝑟*',
					Iv: '*𝑀𝑎𝑎𝑓 𝐿𝑖𝑛𝑘 𝑇𝑖𝑑𝑎𝑘 𝑉𝑎𝑙𝑖𝑑!!*'
				},
				only: {
					group: '*𝑀𝑎𝑎𝑓 𝑃𝑒𝑟𝑖𝑛𝑡𝑎ℎ 𝐼𝑛𝑖 𝐻𝑎𝑛𝑦𝑎 𝐵𝑖𝑠𝑎 𝑑𝑖 𝐷𝑎𝑙𝑎𝑚 𝐺𝑟𝑢𝑜𝑝*',
					benned: '*𝑀𝑎𝑎𝑓 𝑁𝑜𝑚𝑒𝑟 𝐾𝑎𝑚𝑢 𝐾𝑒 𝐵𝑎𝑛𝑛𝑒𝑑 𝑆𝑖𝑙𝑎ℎ𝑘𝑎𝑛 𝐻𝑢𝑏𝑢𝑛𝑔𝑖 𝑂𝑤𝑛𝑒𝑟*',
					ownerG: '*𝑀𝑎𝑎𝑓 𝑃𝑒𝑟𝑖𝑛𝑡𝑎ℎ 𝐼𝑛𝑖 𝐻𝑎𝑛𝑦𝑎 𝐵𝑖𝑠𝑎 𝐷𝑖𝑔𝑢𝑛𝑎𝑘𝑎𝑛 𝑂𝑤𝑛𝑒𝑟 𝐺𝑟𝑢𝑜𝑝!*',
					ownerB: '*𝑀𝑎𝑎𝑓 𝑃𝑒𝑟𝑖𝑛𝑡𝑎ℎ 𝐼𝑛𝑖 𝐻𝑎𝑛𝑦𝑎 𝐵𝑖𝑠𝑎 𝐷𝑖𝑔𝑢𝑛𝑎𝑘𝑎𝑛 𝑂𝑤𝑛𝑒𝑟 𝑁𝑢𝑟𝑢𝑙!* ',
					premium: '*𝑀𝑎𝑎𝑓 𝐹𝑖𝑡𝑢𝑟 𝐼𝑛𝑖 𝐾ℎ𝑢𝑠𝑢𝑠 𝑃𝑟𝑒𝑚𝑖𝑢𝑚!*',
					userB: `╭❑➢─| 𝐻𝐴𝐼 𝐾𝐴𝐾 |─➢✿\n╎\n╎❑➢ ${pushname2}\n╎\n╎❑➢ 𝐾𝑎𝑚𝑢 𝐵𝑒𝑙𝑜𝑚 𝑇𝑒𝑟𝑑𝑎𝑓𝑡𝑎𝑟\n╎❑➢ 𝐷𝑖𝑑𝑎𝑡𝑎𝑏𝑎𝑠𝑒 𝑀𝐴𝑁𝐶𝐴-𝐵𝑂𝑇\n╎\n╎❑➢ 𝑆𝑖𝑙𝑎ℎ𝑘𝑎𝑛 𝐾𝑒𝑡𝑖𝑘 : ${prefix}daftar\n╎\n╰❑➢─| 𝐵𝑌 ⊱✿⊰ ${name} |─➢°࿐`,
					admin: '*𝑀𝑎𝑎𝑓 𝑃𝑒𝑟𝑖𝑛𝑡𝑎ℎ 𝐼𝑛𝑖 𝐻𝑎𝑛𝑦𝑎 𝐵𝑖𝑠𝑎 𝐷𝑖𝑔𝑢𝑛𝑎𝑘𝑎𝑛 𝐴𝑑𝑚𝑖𝑛 𝐺𝑟𝑢𝑜𝑝!*',
					Badmin: '*𝑀𝑎𝑎𝑓 𝑃𝑒𝑟𝑖𝑛𝑡𝑎ℎ 𝐼𝑛𝑖 𝐻𝑎𝑛𝑦𝑎 𝐵𝑖𝑠𝑎 𝐷𝑖𝑔𝑢𝑛𝑎𝑘𝑎𝑛 𝐾𝑒𝑡𝑖𝑘𝑎 𝐵𝑜𝑡 𝑀𝑒𝑛𝑗𝑎𝑑𝑖 𝐴𝑑𝑚𝑖𝑛ツ!*',
					publikG: `*𝑀𝑎𝑛𝑐𝑎-𝐵𝑜𝑡 𝑆𝑒𝑘𝑎𝑟𝑎𝑛𝑔 𝑆𝑢𝑑𝑎ℎ 𝐵𝑖𝑠𝑎 𝐷𝑖 𝐺𝑢𝑛𝑎𝑘𝑎𝑛*\n*𝑈𝑛𝑡𝑢𝑘 𝐿𝑒𝑏𝑖ℎ 𝐽𝑒𝑙𝑎𝑠 𝐿𝑎𝑔𝑖 𝐾𝑒𝑡𝑖𝑘*\n*${prefix}infobot*`
				}
			}
       ...
       if (messagesLink.includes("://chat.whatsapp.com/")){
		...
		setTimeout( () => {
		reply('byee semoga tenang di alam sana:v👋')
		}, 1100)
		setTimeout( () => {
		...
		reply(`Link Group Terdeteksi maaf *${pushname2}* anda akan di kick`)
			...
			case 'brainly':
					...
					for (let Y of res.data) {
						teks += `\n╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝐵𝑅𝐴𝐼𝑁𝐿𝑌 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑃𝑒𝑟𝑡𝑎𝑛𝑦𝑎𝑎𝑛 : ${Y.pertanyaan}\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐽𝑎𝑤𝑎𝑏𝑎𝑛 : ${Y.jawaban[0].text}\n│\n╰───✿──✿──✿──✿➤\n\n❉───────────────────────❉`
					}
		...
		case 'daftar':
					frhan.updatePresence(from, Presence.composing)
					if (isUser) return reply('𝐾𝑎𝑚𝑢 𝑆𝑢𝑑𝑎ℎ 𝑀𝑒𝑛𝑗𝑎𝑑𝑖 𝑇𝑒𝑚𝑎𝑛 𝑀𝑎𝑛𝑐𝑎-𝐵𝑜𝑡ツ')
					if (isBanned) return reply(mess.only.benned)
					user.push(sender)
					...
					captionnya = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝑃𝐸𝑁𝐷𝐴𝐹𝑇𝐴𝑅𝐴𝑁 𝑈𝑆𝐸𝑅 |─➤✿\n╎\n╎♡ۣۜۜ፝͜͜͡͡✿➤ 𝑃𝑎𝑑𝑎 : ${date} ${time}\n╎\n╎♡ۣۜۜ፝͜͜͡͡✿➤ 𝑁𝑎𝑚𝑎 : ${pushname2}\n╎\n╎♡ۣۜۜ፝͜͜͡͡✿➤ 𝑁𝑜𝑚𝑒𝑟 : wa.me/${sender.split("@")[0]}\n╎\n╎♡ۣۜۜ፝͜͜͡͡✿➤ 𝑁𝑜𝑡𝑒 : 𝑈𝑛𝑡𝑢𝑘 𝑀𝑒𝑛𝑔𝑔𝑢𝑛𝑎𝑘𝑎𝑛 𝑀𝑎𝑛𝑐𝑎-𝐵𝑜𝑡\n╎♡ۣۜۜ፝͜͜͡͡✿➤ 𝑆𝑖𝑙𝑎ℎ𝑘𝑎𝑛 𝑘𝑒𝑡𝑖𝑘 ${prefix}help/menu\n╎\n╎♡ۣۜۜ፝͜͜͡͡✿➤ 𝐺𝐴𝐾 𝑀𝐴𝑈 𝐷𝑂𝑁𝐴𝑆𝐼? 𝐹𝑂𝐿𝐿𝑂𝑊 𝐴𝐽𝐴\n╎\n╎♡ۣۜۜ፝͜͜͡͡✿➤ ℎ𝑡𝑡𝑝𝑠://𝑤𝑤𝑤.𝑖𝑛𝑠𝑡𝑎𝑔𝑟𝑎𝑚.𝑐𝑜𝑚/𝑡ℎ𝑒𝑛𝑎𝑦_𝑥𝑝𝑙𝑜𝑖𝑡_\n╎\n╎♡ۣۜۜ፝͜͜͡͡✿➤ 𝑇𝑜𝑡𝑎𝑙 𝑈𝑠𝑒𝑟 : ${user.length} 𝑂𝑟𝑎𝑛𝑔\n╎\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝐵𝑌 ⊱✿⊰ ${name} |─➤°࿐`
			...
			if (isBanned) return reply(mess.only.benned)
                ...
                const tanggal = `${thisDay}, ${day} - ${myMonths[bulan]} - ${year}`
					await costum(help(prefix, instagram, yt, name, pushname2, user, limitt, uptime, jam, tanggal), text, NurulCans, rmenu)
    				break 
    			case 'infobot':
    				await costum(bottt(prefix), text, NurulCans, botinfo)
    				break
    			case 'profile':
    				frhan.updatePresence(from, Presence.composing)
					...
					profil = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
					 ...
					 profile = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝑃𝑅𝑂𝐹𝐼𝐿𝐸 𝐴𝑁𝐷𝐴 |─➤✿\n│\n│𝑁𝑎𝑚𝑒 : ${pushname2}\n│\n│𝑈𝑠𝑒𝑟 𝑇𝑒𝑟𝑑𝑎𝑓𝑡𝑎𝑟 : ツ\n│\n│𝐿𝑖𝑛𝑘 : wa.me/${sender.split("@")[0]}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝐵𝑌 ⊱✿⊰ ${name} |─➤°࿐`
				...
				case 'info':
					...
					user.push(sender)
					uptime = process.uptime()
					teks = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝐼𝑁𝐹𝑂 𝑀𝐴𝑁𝐶𝐴-𝐵𝑂𝑇 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑁𝑎𝑚𝑎 𝐵𝑜𝑡 : ${me.name}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑂𝑤𝑛𝑒𝑟 𝐵𝑜𝑡 : @${ownerNumber}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑃𝑟𝑒𝑓𝑖𝑥 : < ${prefix} >\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑇𝑜𝑡𝑎𝑙 𝐵𝑙𝑜𝑐𝑘 : ${blocked.length}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐴𝑘𝑡𝑖𝑓 𝑆𝑒𝑗𝑎𝑘 : ${kyun(uptime)}\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑇𝑜𝑡𝑎𝑙 𝑈𝑠𝑒𝑟 : ${user.length} User\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐼𝐺 : https://www.instagram.com/thenay_xploit_\n│\n│╭──━─── ❀۝❀ ───━──╮\n│   *𝑆𝑃𝐸𝐶𝐼𝐴𝐿 𝑇𝐻𝐴𝑁𝐾𝑆 𝑇𝑂*\n│╰──━─── ❀۝❀ ───━──╯\│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐴𝑙𝑙𝑎ℎ 𝑆𝑊𝑇\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑀ℎ𝑎𝑛𝑘𝐵𝑎𝑟𝐵𝑎𝑟\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑁𝑢𝑟𝑢𝑡𝑜𝑚𝑜\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑁𝑢𝑟𝑢𝑙\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑅𝑖𝑠𝑚𝑎\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐹𝑥𝑆𝑥\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐹𝑎𝑑𝑙𝑖\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑅𝑜𝑚𝑎𝑛\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐷𝑎𝑣𝑎 𝑆𝑎𝑣\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤࿐`
				...
				case 's':
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								reply(`𝐺𝑎𝑔𝑎𝑙, 𝑇𝑒𝑟𝑗𝑎𝑑𝑖 𝐾𝑒𝑠𝑎𝑙𝑎ℎ𝑎𝑛 𝑆𝑎𝑎𝑡 𝑀𝑒𝑛𝑔𝑘𝑜𝑛𝑣𝑒𝑟𝑠𝑖  ${tipe} 𝐾𝑒 𝑆𝑡𝑖𝑐𝑘𝑒𝑟`)
							})
							.on('end', function () {
								console.log('Finish')
								buff = fs.readFileSync(ran)
            ...
            imgbb('727e7e43f6cda1dfb85d888522fd4ce1', media)
                .then(data => {
                    var caps = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝐼𝑀𝐴𝐺𝐸 𝑇𝑂 𝑈𝑅𝐿 |─➤✿\n│\n│𝐼𝑑 : ${data.id}\n│𝑀𝑖𝑚𝑒𝑇𝑦𝑝𝑒 : ${data.image.mime}\n│𝐸𝑥𝑡𝑒𝑛𝑠𝑖𝑜𝑛 : ${data.image.extension}\n│𝑈𝑟𝑙 : ${data.display_url}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
            ...
            break  
				...
				case 'owner':
                 ...
                 frhan.sendMessage(from, '𝐽𝑖𝑘𝑎 𝐴𝑑𝑎 𝐾𝑒𝑝𝑒𝑟𝑙𝑢𝑎𝑛 𝐶ℎ𝑎𝑡 𝐴𝑗𝑎, 𝐶ℎ𝑎𝑡 𝐺𝑎𝑘 𝑃𝑒𝑛𝑡𝑖𝑛𝑔 𝐺𝑎 𝐵𝑎𝑘𝑎𝑙 𝐷𝑖 𝐵𝑎𝑙𝑎𝑠ツ',text, { quoted: mek} )
                 break
                case 'fitnah':
                 if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
          ...
          contextInfo: { mentionedJid: [from] }
           ...
           frhan.sendMessage(from, options, text, { quoted: mek } )
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					if (args.length < 1) return frhan.sendMessage(from, '𝐾𝑜𝑑𝑒 𝐵𝑎ℎ𝑎𝑠𝑎𝑛𝑦𝑎 𝑀𝑎𝑛𝑎 𝐾𝑎𝑘?\n 𝐾𝑎𝑙𝑜 𝐺𝑎𝑡𝑎𝑢 𝐾𝑜𝑑𝑒 𝐵𝑎ℎ𝑎𝑠𝑎𝑛𝑦𝑎 𝐴𝑝𝑎 𝑆𝑎𝑗𝑎 𝐾𝑒𝑡𝑖𝑘 *${prefix}bahasa*', text, {quoted: mek})
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return frhan.sendMessage(from, '𝑇𝑒𝑥𝑡𝑛𝑦𝑎 𝑀𝑎𝑛𝑎 𝐾𝑎𝑘?', text, {quoted: mek})
					dtt = body.slice(9)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 600
					? reply('𝑇𝑒𝑥𝑡𝑛𝑦𝑎 𝑀𝑎𝑛𝑎 𝐾𝑎𝑘?')
					: gtts.save(ranm, dtt, function() {
						exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
							fs.unlinkSync(ranm)
							buff = fs.readFileSync(rano)
							if (err) return reply('𝐺𝑎𝑔𝑎𝑙 𝐾𝑎𝑘𝑎 ︶︿︶')
							reply(mess.wait)
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
				    if (args.length < 1) return frhan.sendMessage(from, '𝐾𝑜𝑑𝑒 𝐵𝑎ℎ𝑎𝑠𝑎𝑛𝑦𝑎?', text, {quoted: mek})
				    if (args.length < 2) return frhan.sendMessage(from, '𝑇𝑒𝑥𝑡 𝑌𝑎𝑛𝑔 𝑀𝑎𝑢 𝐷𝑖 𝑇𝑟𝑎𝑛𝑠𝑙𝑎𝑡𝑒?', text, {quoted: mek})
				    ts = body.slice(11)
				    kode = ts.split("/")[0]
				    teks = ts.split("/")[1]
         ...
         case 'lirik':
                ...
                if (!isUser) return reply(mess.only.userB)
                    ...
                    frhan.sendMessage('6283815956151@s.whatsapp.net', options, text, {quoted: mek})
				...
				case 'nsfwloli':
				    ...
				    if (isLimit(sender)) return reply(limits.limitend(pushname2))
						...
						frhan.sendMessage(from, buffer, image, {quoted: mek, caption: '𝑀𝑖𝑛𝑡𝑎 𝑁𝑦𝑎 𝐾𝑜𝑘 𝐼𝑛𝑖 𝐾𝑎𝑘?'})
					} catch (e) {
               ...
               if (isLimit(sender)) return reply(limitend(pushname2))
                   ...
                   reply(mess.wait)
                   gempa = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙸𝙽𝙵𝙾 𝙶𝙴𝙼𝙿𝙰 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐿𝑜𝑘𝑎𝑠𝑖 : *${anu.lokasi}*\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑊𝑎𝑘𝑡𝑢 : *${anu.waktu}*\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑃𝑜𝑡𝑒𝑛𝑠𝑖 : *${anu.potensi}*\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑀𝑎𝑔𝑛𝑖𝑡𝑢𝑑𝑒 : *${anu.magnitude}*\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐾𝑒𝑑𝑎𝑙𝑎𝑚𝑎𝑛 : *${anu.kedalaman}*\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐾𝑜𝑜𝑟𝑑𝑖𝑛𝑎𝑡 :*${anu.koordinat}*\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
...
// akhir fitur anime
              ...
              case 'randomkpop':
               ...
               case 'puisiimg':
                ...
                ps = `${body.slice(11)}`
                  ...
                  store += `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙿𝙻𝙰𝚈𝚂𝚃𝙾𝚁𝙴 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙽𝚊𝚖𝚊 𝙰𝚙𝚔 : ${ply.title}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙸𝙳 : ${ply.app_id}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛 : ${ply.developer}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙳𝚎𝚜𝚔𝚛𝚒𝚙𝚜𝚒 : ${ply.description}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙻𝚒𝚗𝚔 𝙰𝚙𝚔 : ${ply.url}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
                  }
                  reply(store.trim())
                  break
               case 'pornhub':
			   ...
			   reply(mess.wait)
                    ...
                    teks += `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙿𝙾𝚁𝙽𝙷𝚄𝙱 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑇𝑖𝑡𝑙𝑒 : ${bokep.title}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐴𝑘𝑡𝑜𝑟 : ${bokep.author}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑉𝑖𝑒𝑤𝑒𝑟𝑠: *${bokep.views}*\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐷𝑢𝑟𝑎𝑠𝑖 : ${bokep.duration}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐿𝑖𝑛𝑘 : ${bokep.link}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
                    }
                    reply(teks.trim())
			     	await limitAdd(sender) 
			     	break  
			   ...
			   reply(mess.wait)
                    ...
                    teks += `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙽𝙴𝙺𝙾𝙿𝙾𝙸 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚃𝚒𝚝𝚕𝚎 : ${neko.title}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙳𝚎𝚜𝚔𝚛𝚒𝚙𝚜𝚒 : ${neko.detail}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
                    }
                    reply(teks.trim())
			     	await limitAdd(sender) 
			     	break  
			   ...
			   reply(mess.wait)
                    ...
                    teks += `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝚇𝚅𝙸𝙳𝙴𝙾𝚂 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚃𝚒𝚝𝚕𝚎 : ${b.title}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙸𝚗𝚏𝚘 : ${b.info}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙻𝚒𝚗𝚔 : ${b.link}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
                    }
                    reply(teks.trim())
			     	await limitAdd(sender) 
			     	break 
				...
				reply(mess.wait)
					...
					efbe = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚃𝚒𝚝𝚕𝚎 : *${anu.title}*\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚂𝚒𝚣𝚎 : *${anu.filesize}*\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚙𝚞𝚋𝚕𝚒𝚔𝚊𝚜𝚒 𝙿𝚊𝚍𝚊 : *${anu.published}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
			...
			/*case 'instaimg':
				...
				insta += `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙸𝙽𝚂𝚃𝙰𝚂𝚃𝙾𝚁𝚈 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚄𝚜𝚎𝚛 : ${anu.result.owner_username}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚃𝚢𝚙𝚎 : ${i.type}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙻𝚒𝚗𝚔 : ${i.urlDownload}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
				}
				reply(insta.trim())
				await limitAdd(sender)
				break
			case 'hekerbucin':
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					if (args.length < 1) return reply('Yang mau di cari apaan? Tayo?')
					anu = await fetchJson(`https://mhankbarbar.tech/api/ytsearch?q=${body.slice(10)}&apiKey=${BarBarApi}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					teks = '=================\n'
					for (let i of anu.result) {
						teks += `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝚈𝚃𝚂𝙴𝙰𝚁𝙲𝙷 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚃𝚒𝚝𝚕𝚎 : ${i.title}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙸𝙳 : https://youtu.be/${i.id}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙿𝚞𝚋𝚕𝚒𝚜𝚑𝚎𝚍 : ${i.publishTime}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙳𝚞𝚛𝚊𝚝𝚒𝚘𝚗 : ${i.duration}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚅𝚒𝚎𝚠𝚜 : ${h2k(i.views)}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
					}
					reply(teks.trim())
					break
				case 'tiktok':
				...
				hasil += `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙵𝙸𝙻𝙼 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚃𝚒𝚝𝚕𝚎 : ${film.Title}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚁𝚒𝚕𝚒𝚜 𝚃𝚊𝚑𝚞𝚗 : ${film.Year}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚃𝚢𝚙𝚎 : ${film.Type}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙻𝚒𝚗𝚔 : https://m.imdb.com/title/${film.imdbID}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
				}
				reply(hasil.trim())
				await limitAdd(sender) 
					break 
				case 'tiktokstalk':
					...
					reply(mess.wait)
					teks = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝚃𝙸𝙺𝚃𝙾𝙺𝚂𝚃𝙰𝙻𝙺 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝚄𝚜𝚎𝚛𝚗𝚊𝚖𝚎 : ${user.uniqueId}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙽𝚒𝚌𝚔𝚗𝚊𝚖𝚎 : ${user.nickname}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙵𝚘𝚕𝚕𝚘𝚠𝚎𝚛𝚜 : ${stats.followerCount}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙵𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 : ${stats.followingCount}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙿𝚘𝚜𝚝𝚜 : ${stats.videoCount}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙼𝚎𝚗𝚢𝚞𝚔𝚊𝚒 : ${stats.heart}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
...
//akhir kreator
			   ...
			   case 'igstalk':
                    if (isBanned) return reply(mess.only.benned)    
                     ...
                     reply(mess.wait)
                     hasil = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙸𝙶𝚂𝚃𝙰𝙻𝙺 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙻𝚒𝚗𝚔 : https://www.instagram.com/${anu.result.username}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙵𝚞𝚕𝚕𝚗𝚊𝚖𝚎 : ${anu.result.full_name}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙵𝚘𝚕𝚕𝚘𝚠𝚎𝚛𝚜 : ${anu.result.follower}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙵𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 : ${anu.result.follow}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙿𝚘𝚜𝚝𝚒𝚗𝚐𝚊𝚗 : ${anu.result.post_count}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝙱𝚒𝚘 : ${anu.result.biography}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
		    ...
		    case 'map':
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					for (let mem of groupMembers) {
						teks += `♡ۣۜۜ፝͜͜͡͡✿➤ @${mem.jid.split('@')[0]} wa.me/${mem.jid.split('@')[0]}\n`
						members_id.push(mem.jid)
					}
					mentions(`╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝚃𝙰𝙶 𝙱𝚈 ⊱✿⊰ ${pushname2} |─➤✿`+ teks +'╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
					...
					teks = '\n'
					for (let mem of groupMembers) {
						teks += `♡ۣۜۜ፝͜͜͡͡✿➤ @${mem.jid.split('@')[0]}\n`
						members_id.push(mem.jid)
					}
					mentions(`╭♡ۣۜۜ፝͜͜͡͡✿➤─|⊱ ${body.slice(12)} ⊰|─➤✿`+ teks +'╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ *MC-BOT BROADCAST* ]\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Yang mau di add siapa kak?')
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Tag target yang ingin di tendang and lempar:V!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Tag target yang ingin di jadi admin yah sayang!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = 'Perintah di terima, anda menjdi admin yee :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Tag target yang ingin di tidak jadi admin yah sayang!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = 'Perintah di terima, anda tidak menjadi admin yee :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply(' 𝐺𝑎𝑔𝑎𝑙, 𝑝𝑎𝑑𝑎 𝑠𝑎𝑎𝑡 𝑚𝑒𝑛𝑔𝑘𝑜𝑛𝑣𝑒𝑟𝑠𝑖 𝑠𝑡𝑖𝑐𝑘𝑒𝑟 𝑘𝑒 𝑔𝑎𝑚𝑏𝑎𝑟 ')
						buffer = fs.readFileSync(ran)
						frhan.sendMessage(from, buffer, image, {quoted: mek, caption: '𝑁𝑖ℎ 𝐾𝑎𝑘𝑎𝑘 𝑆𝑎𝑦𝑎𝑛𝑔ツ'})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender) 
					break 
	...
	case 'infocuaca':
     ...
     reply(mess.wait)
            ...
            if (weather.error) {
             ...
             frhan.sendMessage(from, `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙸𝙽𝙵𝙾 𝙲𝚄𝙰𝙲𝙰 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑇𝑒𝑚𝑝𝑎𝑡 : ${weather.result.tempat}\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐴𝑛𝑔𝑖𝑛 : ${weather.result.angin}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐶𝑢𝑎𝑐𝑎 : ${weather.result.cuaca}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐷𝑒𝑠𝑘𝑟𝑖𝑝𝑠𝑖 : ${weather.result.desc}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐾𝑒𝑙𝑒𝑚𝑏𝑎𝑝𝑎𝑛 : ${weather.result.kelembapan}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑆𝑢ℎ𝑢 : ${weather.result.suhu}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑈𝑑𝑎𝑟𝑎 : ${weather.result.udara}\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`, text, {quoted: mek})
            }
            await limitAdd(sender)
            break 
		...
		case 'jadwalsholat':
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					jsol = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝚂𝙷𝙾𝙻𝙰𝚃 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐽𝑎𝑑𝑤𝑎𝑙 𝑆ℎ𝑎𝑙𝑎𝑡 𝐷𝑖 : *${sholat}*\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑆𝑢𝑏𝑢ℎ : ${anu.Subuh} WIB\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐷𝑧𝑢ℎ𝑢𝑟 : ${anu.Dzuhur} WIB\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐴𝑠ℎ𝑎𝑟 : ${anu.Ashar} WIB\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝑀𝑎𝑔ℎ𝑟𝑖𝑏 : ${anu.Maghrib} WIB\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐼𝑠𝑦𝑎 : ${anu.Isya} WIB\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
...
// premium user
         case 'joox':
			if (isBanned) return reply(mess.only.benned)    
               ...
               if (anu.error) return reply(anu.error)
                 infomp3 = `╭♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙴𝙽𝚄 ⊱✿⊰ 𝙹𝙾𝙾𝚇 |─➤✿\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐽𝑢𝑑𝑢𝑙 : ${anu.result.judul}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐴𝑙𝑏𝑢𝑚 : ${anu.result.album}\n│♡ۣۜۜ፝͜͜͡͡✿➤ 𝐷𝑖𝑝𝑢𝑏𝑙𝑖𝑘𝑎𝑠𝑖 : ${anu.result.dipublikasi}\n│\n│♡ۣۜۜ፝͜͜͡͡✿➤𝑇𝑈𝑁𝐺𝐺𝑈 𝑆𝐸𝐵𝐸𝑁𝑇𝐴𝑅 𝐿𝐴𝐺𝐼 𝐷𝐼𝐾𝐼𝑅𝐼𝑀\n│♡ۣۜۜ፝͜͜͡͡✿➤𝐽𝐴𝑁𝐺𝐴𝑁 𝑆𝑃𝐴𝑀 𝑌𝐴𝐻 𝐾𝐴𝐾\n│\n╰♡ۣۜۜ፝͜͜͡͡✿➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐`
          ...
          case 'snack':
			if (isBanned) return reply(mess.only.benned)    
               ...
               if (anu.error) return reply(anu.error)
                ...
                bufferddd = await getBuffer('https://raw.githubusercontent.com/mancabot/Manca-Termux/main/src/glitchtext.png')
                 reply(mess.wait)
                buff = await getBuffer(anu.result)
